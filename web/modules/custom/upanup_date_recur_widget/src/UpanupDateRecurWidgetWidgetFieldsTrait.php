...
namespace Drupal\upanup_date_recur_widget;
 ...
 */
trait UpanupDateRecurWidgetWidgetFieldsTrait {
  ...
  protected function getFieldEndsMode(): array {
    return [
      ...
      '#options' => [
        ...
        UpanupDateRecurWidgetWidgetOptions::ENDS_MODE_OCCURRENCES => $this->t('After number of occurrences'),
        UpanupDateRecurWidgetWidgetOptions::ENDS_MODE_ON_DATE => $this->t('On date'),
      ],
    ];
  }
