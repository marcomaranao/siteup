 ...
 */
abstract class UpanupDateRecurWidgetWidgetBase extends WidgetBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new UpanupDateRecurWidgetWidgetBase.
   *
