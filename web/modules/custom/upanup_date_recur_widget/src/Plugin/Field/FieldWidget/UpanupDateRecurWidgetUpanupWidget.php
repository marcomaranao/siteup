...
namespace Drupal\upanup_date_recur_widget\Plugin\Field\FieldWidget;
...
use Drupal\upanup_date_recur_widget\Form\UpanupDateRecurWidgetUpanupModalForm;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Date recur upanup widget.
 *
 ...
 *
 * @FieldWidget(
 *   id = "upanup_date_recur_widget_upanup",
 *   label = @Translation("Modular: Upanup"),
 *   field_types = {
 *     "date_recur"
 *   }
 * )
 */
class UpanupDateRecurWidgetUpanupWidget extends UpanupDateRecurWidgetWidgetBase {
   ...
   */
  public const COLLECTION_MODAL_STATE = 'upanup_date_recur_widget_upanup_modal_state';
   ...
   * Form state key.
   */ 
  protected const FORM_STATE_RRULE_KEY = 'upanup_date_recur_widget_upanup_rrule';
  ...
  /**
   * Constructs a new UpanupDateRecurWidgetUpanupWidget.
   *
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state): array {
    ...
    $element['#theme'] = 'upanup_date_recur_widget_upanup_widget';
    ...
    $element['buttons']['custom_recurrences'] = [
      ...
      '#attributes' => [
        'class' => [
          'js-hide',
          'upanup-date-recur-widget-upanup-widget-recurrence-open',
        ],
      ],
    ...
    $element['buttons']['reload_recurrence_dropdown'] = [
      ...
      '#attributes' => [
        'class' => [
          'js-hide',
          'upanup-date-recur-widget-upanup-widget-reload-recurrence-options',
        ],
      ],
      '#limit_validation_errors' => [],
      // Needs a name so triggering element works on multicardinal elements.
    ...
    $element['day_start'] = [
      ...
      '#attributes' => [
        'type' => 'date',
        'class' => ['upanup-date-recur-widget-upanup-widget-start-date'],
      ],
    ...
    $element['day_end'] = [
      ...
      '#attributes' => [
        'type' => 'date',
        'class' => ['upanup-date-recur-widget-upanup-widget-start-end'],
      ],
      '#date_date_format' => 'Y-m-d',
    ];
    ...
    $element['recurrence_option'] = [
      ...
      '#suffix' => '</div>',
      '#attributes' => [
        'class' => ['upanup-date-recur-widget-upanup-widget-recurrence-option'],
      ],
    ];
  ...
  public function openTheModal(array &$form, FormStateInterface $form_state) {
    ...
    $content = $this->formBuilder
      ->getForm(UpanupDateRecurWidgetUpanupModalForm::class);
